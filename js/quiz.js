var quiztitle = "Placeholder Quiz";
...
var quiz = [
       ...
       {
           "question" : "Q2: The Myers-Briggs 16 personality type test is adored in popular media as well as in corporate enterprises. But what is the chance of you getting the same personality type when doing the test twice, five weeks apart?",
           "choices" : [
                                   "80%",
                                   "70%",
                                   "50%",
   ...
   jQuery(document).ready(function ($) {
       ...
       function endQuiz() {
           ...
           $('<a href="'+"main.html"+'">'+"Now explore the data for yourself"+'</a>').appendTo($('#frame'));
       }
